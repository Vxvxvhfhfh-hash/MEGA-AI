...
const defaultOwner = '+22678363200';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '+22678363200' ; // put your number here
...
//
global.botname = process.env.BOTNAME || 'UNSTRALER';
global.pairingNumber = process.env.BOT_NUMBER || '+22678363200' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'nch1mBYR#tkeUl8x-lfsX8rsNrJaueYeYsMeBrHwsnwYCtoIyqN0' ;  // put your session id here
